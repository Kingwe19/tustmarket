          ...
          <i class="el-icon-zoom-in"></i>
            ...
            <el-col :span="9" :offset="2" style="margin-top: 50px;">
              <el-form-item label="商品名称" prop="name">
                <el-input v-model="submitGoodsForm.goodsName" maxlength="25" show-word-limit></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="9" :offset="2" style="margin-top: 50px;">
            ...
            <el-col :span="9" :offset="2" style="margin-top: 20px;">
              <el-form-item label="商品介绍" prop="dscrip">
                <el-input
                  ...
                  placeholder="请输入内容"
                  v-model="submitGoodsForm.goodsDescription"
                  maxlength="100"
                  show-word-limit>
                </el-input>
              </el-form-item>
            ...
            <el-col :span="9" :offset="2" style="margin-top: 20px;">
              <el-form-item label="商品种类" prop="goodsKinds">
                <el-select v-model="submitGoodsForm.goodsKinds" placeholder="请选择">
                  <el-option
...
<script>
  ...
  export default {
    ...
    mounted() {
      ...
      let self = this;
      $.get("http://localhost:8083/goods/getRandomGoodsId", function (data) {
        self.submitGoodsForm.goodsId = data.goodsId;
        //设置上传图片路径，需要一个商品ID
        self.action = "http://localhost:8083/upload/uploadFile?goodsId=" + data.goodsId;
      }, "json");
    },
    methods: {
      submitForm(formName) {
        if (this.submitFlag) {
          this.$refs[formName].validate((valid) => {
            if (valid) {
              ...
              $.post("http://localhost:8083/goods/createGoods", jsonMsg, function (data) {
                if (data.code === 1) {
