    ...
    <nav class="navbar index-header-bar">
      <el-row>
        <el-col :span="3" :offset="3">
          <img src="http://localhost:9090/keda.png" style="height: 20px;width: 20px" />
          <span>天津科技大学校园二手交易平台</span>
        </el-col>
        <el-col :span="14" :offset="3">
          <el-row>
            ...
            <el-col :span="2" :offset="1" class="index-header-bar-span">
              <a href="#" data-toggle="dropdown">分类</a>
              <ul class="dropdown-menu my-dropdown-menu-1">
                <li>
                  <a class="my-dropdown-menu-li-1" @click="changeSelect(1)">服饰</a>
                </li>
                <li>
                  <a class="my-dropdown-menu-li-1" @click="changeSelect(2)">配饰</a>
                </li>
                <li>
                  <a class="my-dropdown-menu-li-1" @click="changeSelect(3)">鞋子</a>
                </li>
                <li>
                  <a class="my-dropdown-menu-li-1" @click="changeSelect(4)">美妆洗护</a>
                </li>
                <li>
                  <a class="my-dropdown-menu-li-1" @click="changeSelect(5)">电子数码</a>
                </li>
                <li>
                  <a class="my-dropdown-menu-li-1" @click="changeSelect(6)">运动户外</a>
                </li>
                <li>
                  <a class="my-dropdown-menu-li-1" @click="changeSelect(7)">图书文娱</a>
                </li>
                <li>
                  <a class="my-dropdown-menu-li-1" @click="changeSelect(8)">演出票</a>
                </li>
                <li>
                  <a class="my-dropdown-menu-li-1" @click="changeSelect(9)">生活旅行</a>
                </li>
                <li>
                  <a class="my-dropdown-menu-li-1" @click="changeSelect(10)">箱包烟酒</a>
                </li>
                <li>
                  <a class="my-dropdown-menu-li-1" @click="changeSelect(11)">宠物</a>
                </li>
                <li>
                  <a class="my-dropdown-menu-li-1" @click="changeSelect(12)">其他</a>
                </li>
              </ul>
            </el-col>
            <el-col :span="2" :offset="1" class="index-header-bar-span">
              <router-link to="shopCar"><img src="http://localhost:9090/shopcar.png" alt="" style="width: 20px;">
                我的收藏
              </router-link>
            </el-col>
            <el-col :span="2" :offset="1" class="index-header-bar-span">
            ...
            <el-col :span="2" :offset="1" class="index-header-bar-span">
              ...
              <ul class="dropdown-menu my-dropdown-menu-1">
<!--                <li>-->
<!--                  <a class="my-dropdown-menu-li-1" @click="feedback">我的反馈</a>-->
<!--                </li>-->
                <li>
...
<script>
  ...
  export default {
    ...
    // },
    methods: {
      changeSelect(selectNum){
        this.$router.push("/" + selectNum);
        this.$router.go(0);
      },
      checkLogin1() {
